...
public class PatternDetectorAlgorithm implements PatternDetectorAlgorithmInterface{
    ...
    public PatternCoordinator find(Mat rgba, Mat gray2) {
        ...
        detectedPattern = new PatternCoordinator(
            ...
            new Point(detectedPattern.getNum1().y, detectedPattern.getNum1().x),
            new Point(detectedPattern.getNum2().y, detectedPattern.getNum2().x),
            new Point(detectedPattern.getNum3().y, detectedPattern.getNum3().x),
            new Point(detectedPattern.getNum4().y, detectedPattern.getNum4().x),
            0.0
        );
